...
const Player = () => {
    ...
    const { track, seekBar, seekBg, playStatus, play, pause, time, previous, next, seekSong, replay ,volume, adjustVolume,isShuffle, toggleShuffle} = useContext(PlayerContext);
